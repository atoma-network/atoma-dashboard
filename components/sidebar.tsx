...
const navigation = [
  ...
  {
    name: "Docs",
    href: "https://docs.atoma.network/cloud-api-reference/get-started",
    icon: FileText,
  },
    ...
    <TooltipProvider>
      <>
        ...
        >
          <div className="border-b border-border dark:bg-darkMode">
            <div
              className={cn("flex h-16 items-center gap-2 px-4 dark:bg-darkMode", isCollapsed && "justify-center px-2")}
            >
              {!isCollapsed && (
