...
export default function Dashboard() {
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
      <div className="flex flex-col h-screen bg-purple-50 dark:bg-gray-900">
        <header className="bg-white dark:bg-gray-800 border-b border-purple-200 dark:border-gray-700 p-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-purple-700 dark:text-purple-400">Atoma Platform</h1>
